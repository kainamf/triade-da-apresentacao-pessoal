...
import { Calendar, User, MessageSquare, Heart, MapPin } from 'lucide-react';

export default function About() {
    return (
        <section id="evento" className="py-20 bg-primary-100 relative overflow-hidden">
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-6xl mx-auto">
                    ...
                    </div>                    {/* Vogue Gallery Section */}
                    <div className="bg-background backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-xl mt-8">
                        {/* Title */}
