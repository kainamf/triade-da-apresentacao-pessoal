import { PHONE, EMAIL, WHATSAPP_LINK, INSTAGRAM_LINK, LINKEDIN_LINK, FACEBOOK_LINK } from '../constants';

function Contact() {
    return (
        <section id="contato" className="py-16 bg-primary-300">
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-secondary-100 text-font mb-4">Entre em Contato</h2>
                    <p className="text-xl text-secondary-100 text-font">Transforme sua apresentação pessoal com a Tríade</p>
                </div>
                {/* Layout com apenas Informações de Contato */}
                <div className="max-w-4xl mx-auto">
                    <div className="space-y-4 flex flex-col">
                        {/* Informações de Contato */}
                        <div className="bg-background p-6 shadow-lg w-auto mx-auto">
                            ...
                            <div className="flex flex-col gap-y-1">
                                ...
                                >
                                    <div className="bg-primary-700 p-3 transition-colors">
                                ...
                                <a
                                    ...
                                    style={{ minWidth: 0 }}
                                >
                                    <div className="bg-primary-700 p-3 flex items-center justify-center transition-colors">
